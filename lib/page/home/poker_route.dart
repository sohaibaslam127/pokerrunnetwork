                        ...
                        children: [
                          ...
                          onPress(
                            ...
                            child: textFieldWithPrefixSuffuxIconAndHintText(
                              ...
                              line: 2,
                              controller: startingPointAddressController,
                              fillColor: Colors.white,
                              mainTxtColor: Colors.black,
                              radius: 12,
                              bColor: Color(0xffEDF1F3),
                              ...
                              pColor: MyColors.primary,
                              enable: startingPointAddressController.text
                                  .trim()
                                  .isNotEmpty,
                            ),
                          ),
                          ...
                          onPress(
                            ...
                            child: textFieldWithPrefixSuffuxIconAndHintText(
                              'Select Address of Final Destination'.tr,
                              controller: finalDestinationAddressController,
                              enable: finalDestinationAddressController.text
                                  .trim()
                                  .isNotEmpty,
                              line: 2,
                              onChange: () {
                            ...
                            onTap: () {
                              ...
                              if (startingPointAddressController.text
                                  ...
                                  finalDestinationAddressController.text
                                      .trim()
                                      .isEmpty ||
                                  startingPointController.text.trim().isEmpty ||
