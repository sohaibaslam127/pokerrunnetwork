...
class _SplashScreenState extends State<SplashScreen> {
  ...
  /// Both strings can be in "X.Y.Z" or "X.Y.Z+build" format.
  /// Only the version numbers (major.minor.patch) are compared; build numbers are ignored.
  ...
  Future<void> _checkForUpdate() async {
    if (appVersionPlayer.isEmpty) return;
    final currentVersion = '$version';
    if (!_isNewerVersion(appVersionPlayer, currentVersion)) return;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2.h),
                    text_widget(
                      "A new version ($appVersionPlayer) of Poker Run Player is available. Please update to continue.",
                      fontSize: 14.5.sp,
